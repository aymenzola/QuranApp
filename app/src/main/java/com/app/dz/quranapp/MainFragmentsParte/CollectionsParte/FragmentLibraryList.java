...
import static com.app.dz.quranapp.MainFragmentsParte.HomeFragment.HomeFragment.BOOKS_TYPE;
...
import static com.app.dz.quranapp.PlayerAudioNotification.Statics.countItemsCount_abudawaed;
import static com.app.dz.quranapp.PlayerAudioNotification.Statics.countItemsCount_bukhari;
import static com.app.dz.quranapp.PlayerAudioNotification.Statics.countItemsCount_hisn_muslim;
import static com.app.dz.quranapp.PlayerAudioNotification.Statics.countItemsCount_ibn_majah;
import static com.app.dz.quranapp.PlayerAudioNotification.Statics.countItemsCount_nisai;
import static com.app.dz.quranapp.PlayerAudioNotification.Statics.countItemsCount_sahih_muslim;
...
import com.app.dz.quranapp.AdkarDetailsParte.ActivityDikrDetailsList;
import com.app.dz.quranapp.CollectionParte.BooksParte.ActivityBooksList;
...
import com.app.dz.quranapp.MainFragmentsParte.AdkarParte.AdkarCategoryAdapter;
...
public class FragmentLibraryList extends Fragment implements EasyPermissions.PermissionCallbacks {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.included.tvTitle.setText("المكتبة");
        binding.included.imgSearch.setVisibility(View.GONE);
        setObservers();
        setListenrs();
        Bundle bundle = getArguments();
        if (bundle != null) {
            type = bundle.getInt("type", BOOKS_TYPE);
            if (type == BOOKS_TYPE) {
                bookTabClicked();
            } else {
                adkarTabClicked();
    ...
    private void setListenrs() {
        ...
        binding.tvMoveLibrary.setOnClickListener(v -> MoveToHadithDetails());
    ...
    public void initializeAdkarAdapter(List<Chapter> items) {
        AdkarCategoryAdapter adapter_adkar = new AdkarCategoryAdapter(items, getActivity(), model -> moveToAdkarDetails(model));
