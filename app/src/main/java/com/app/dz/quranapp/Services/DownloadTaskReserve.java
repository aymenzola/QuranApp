...
public class DownloadTaskReserve extends AsyncTask<String, Integer, Integer> {
    ...
    public DownloadTaskReserve(String url, File outputFile, DownloadListeners listener) {
        this.url = url;
