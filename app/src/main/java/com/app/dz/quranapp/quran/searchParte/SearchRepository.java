package com.app.dz.quranapp.quran.searchParte;

import static com.app.dz.quranapp.quran.searchParte.SearchActivity.searchPageSize;
...
public class SearchRepository {
    ...
    public void searchInHadith(String query, int offset){
        ...
        compositeDisposable.add(bookdao.searchInHadith(query,searchPageSize,offset)
    ...
    public void searchInBooks(String query, int offset){
        ...
        compositeDisposable.add(bookdao.searchInBooks(query,searchPageSize,offset)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(bookList1 -> {
    ...
    public void searchInChapter(String query, int offset){
        Log.e("checkdata","we are getting data");
        compositeDisposable.add(bookdao.searchInChapter(query,searchPageSize,offset)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
