...
public class ActivityHadithDetailsListDev extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            Log.e("quran_tag", "we recieve chapter " + chapter.bookName + " " + collectionName + " " + chapter.bookNumber + " " + chapter.positionInChaptersList);

            /*
            String chaptersJson = intent.getStringExtra("chaptersList", "no");
            if (!chaptersJson.equals("no")) {
                Type type = new TypeToken<ArrayList<Chapter>>() {
                }.getType();
                chaptersList = new Gson().fromJson(chaptersJson, type);
                getHadithList(collectionName, bookNumber);
            } else {
    ...
    private void setListeners() {
        ...
        binding.tvChangeRiwaya.setOnClickListener(v -> {
            Intent intent = new Intent(ActivityHadithDetailsListDev.this, BooksNewActivity.class);
        ...
        binding.cardSaveHadith.setOnClickListener(v -> {
            ...
            if (ChapterUtils.isChapterSaved(ActivityHadithDetailsListDev.this, chapter)) {
                ...
                ChapterUtils.updateChapter(ActivityHadithDetailsListDev.this, chapter);
                Toast.makeText(ActivityHadithDetailsListDev.this, "تم الغاء حفظ الحديث", Toast.LENGTH_SHORT).show();

            } else {
                Glide.with(this).load(R.drawable.ic_saved_new).into(binding.imgSave);
                chapter.isSaved = true;
                ChapterUtils.updateChapter(ActivityHadithDetailsListDev.this, chapter);
                ChapterUtils.saveLastChapter(ActivityHadithDetailsListDev.this, chapter);
        ...
        binding.viewpager.registerOnPageChangeCallback(new androidx.viewpager2.widget.ViewPager2.OnPageChangeCallback() {
            ...
            public void onPageSelected(int position) {
                ...
                if (ChapterUtils.isChapterSaved(ActivityHadithDetailsListDev.this, chapter)) {
                    Glide.with(ActivityHadithDetailsListDev.this).load(R.drawable.ic_saved_new).into(binding.imgSave);
                } else {
                    Glide.with(ActivityHadithDetailsListDev.this).load(R.drawable.ic_unsaved_new).into(binding.imgSave);
                }
            }
        });
    }
    ...
    private void setObservers() {
        ...
        viewModel.getChaptersList().observe(ActivityHadithDetailsListDev.this, chapterList -> {
        ...
        viewModel.getHadithListOfBook().observe(ActivityHadithDetailsListDev.this, hadithList -> {
    ...
    public String getCollectionArabicName(String collectionName) {
        Log.e("quran_tag", "getCollectionArabicName for " + collectionName);
