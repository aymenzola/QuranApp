...
public class Statics {
    ...
    public static final int NOTIFICATION_ID_DOWNLOAD_FOREGROUND_SERVICE = 90001;
    ...
    public static class ACTION {
        ...
        public static final String CHANGE_SPEED_ACTION = "music.action.change_speed";
        public static final String CHANGE_READER_ACTION = "music.action.change_reader";
        ...
        public static final String SEEK_ACTION = "music.action.seek";
