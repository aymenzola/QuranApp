...
public class TafsirAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TafsirAdapter(Context mCtx, int textsize, OnAyaClickListener listener1) {
        this.mCtx = mCtx;
